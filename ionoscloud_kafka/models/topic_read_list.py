...
class TopicReadList(BaseModel):
    """
    TopicReadList
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the list of Topic resources.")
    type: Optional[StrictStr] = Field(default=None, description="The type of the resource.")
    href: Optional[StrictStr] = Field(default=None, description="The URL of the list of Topic resources.")
    items: Optional[List[TopicRead]] = Field(default=None, description="The list of Topic resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "href": obj.get("href"),
            "items": [TopicRead.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
