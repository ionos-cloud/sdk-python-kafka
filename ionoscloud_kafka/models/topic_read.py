...
class TopicRead(BaseModel):
    ...
    TopicRead
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID (UUID) of the Topic.")
    type: Optional[StrictStr] = Field(default=None, description="The type of the resource.")
    href: Optional[StrictStr] = Field(default=None, description="The URL of the Topic.")
    metadata: Optional[ResourceMetadata] = None
    properties: Optional[Topic] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": Topic.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
