...
from ionoscloud_kafka.api_response import ApiResponse, T as ApiResponseT
import ionoscloud_kafka.models
from ionoscloud_kafka import rest
from ionoscloud_kafka.exceptions import (
    ApiValueError,
    ApiException,
    ApiFailedRequest,
    ApiTimeout,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'ionos-cloud-sdk-python/v1.0.0-beta.1'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ionoscloud_kafka.models, klass)
